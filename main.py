...
def draw_lives(param1, param2):
    pass


def hide_cross_lives(param, param1):
    pass
...
while game_running:
    if game_over:
        ...
        game_over = False
        player_lives = 3
        draw_lives(5, 'images/red_lives.png')
        score = 0
